                        ...
                        if(response.data){
                            ...
                            instance.tableOptions = {
                                ...
                                filters: [
                                    ...
                                    {title: 'lang.category', key: 'categories', type: 'dropdown', languageType: "raw", options: categories},
                                    {title: 'lang.brand', key: 'brands', type: 'dropdown', languageType: "raw", options: brands},
                                    {title: 'lang.group', key: 'groups', type: 'dropdown', languageType: "raw", options: groups},
                                    {title: 'lang.customer', key: 'customers', type: 'dropdown', languageType: "raw", options: customers},
                                    {title: 'lang.employee', key: 'employee', type: 'dropdown', languageType: "raw", options: employee},
                                ]
                            }
                        }
