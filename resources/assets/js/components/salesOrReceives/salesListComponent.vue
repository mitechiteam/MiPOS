                        ...
                        if (response.data) {
                            ...
                            instance.tableOptions = {
                                ...
                                columns: [
                                    ...
                                    // {
                                    //     title: 'lang.status', key: 'payment_status', type: 'custom',
                                    //     modifier: function (rowData) {
                                    //         // if (!_.empty){
                                    //
                                    //         // }
                                    //         // if (rowData != undefined && rowData == 'Paid') {
                                    //             return {
                                    //                 value: 'paid',
                                    //                 class: "badge badge-success"
                                    //             }
                                    //         // } else if (rowData != undefined && rowData == 'Due') {
                                    //         //     return {
                                    //         //         value: 'due',
                                ...
                                source: "/sales-list-getdata/" + instance.branch_id,
                                summary: true,
                                search: true,
                                sortedBy: "id",
                                sortedType: "DESC",
