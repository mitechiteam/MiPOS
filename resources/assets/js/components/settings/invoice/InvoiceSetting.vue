        ...
        <div class="main-layout-card-header">
            <div class="main-layout-card-content-wrapper">
                <div class="main-layout-card-header-contents">
                    <h5 class="bluish-text m-0">{{ trans('lang.sales_invoice_settings') }}</h5>
                </div>
            </div>
        </div>
            ...
            <form v-else>
                <div class="mb-3">
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            ...
                            <input
                                ...
                                class="form-control"
                                id="invoice-prefix"
                                v-model="invoice.invoice_prefix"
                            />
                        </div>
                        <div class="form-group offset-md-1 col-md-5">
                            ...
                            <input
                                ...
                                class="form-control"
                                id="invoice-suffix"
                                v-model="invoice.invoice_suffix"
                            />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            ...
                            <input
                                ...
                                v-model="invoice.invoice_starts_from"
                            />
                        </div>
                        <div class="form-group offset-md-1 col-md-5">
                    ...
                    <div class="form-row">
                        <div class="col-md-5">
                            ...
                            <div class="form-check">
                                <input
                                    ...
                                    v-model="invoice.auto_generate_invoice"
                                    type="radio"
                        ...
                        <div class="form-group offset-md-1 col-md-5">
                            <label>{{ trans('lang.auto_email_receive') }}</label>
                            <div class="form-check">
                                <input
                                    class="form-check-input"
                                    v-model="invoice.auto_email_receive"
                                    type="radio"
                                    name="auto-email-receive"
                                    id="auto-email-receive-1"
                                    value="1"
                                />
                                <label
                                    for="auto-email-receive-1"
                                    class="radio-button-label"
                                >{{ trans('lang.yes') }}</label>
                                <input
                                    class="form-check-input"
                                    ...
                                    type="radio"
                                    name="auto-email-receive"
                                    id="auto-email-receive-2"
                                    value="0"
                                />
                                <label
                                    for="auto-email-receive-2"
                                    class="radio-button-label"
                                >{{ trans('lang.no') }}</label>
                            </div>
                        </div>
...
export default {
    ...
    created() {
        this.getInvoiceSettingData("/invoice-setting-data");
    },
    methods: {
        ...
        invoiceSettingsUpdate() {
            ...
            this.inputFields = {
                invoicePrefix: this.invoice.invoice_prefix,
                invoiceSuffix: this.invoice.invoice_suffix,
                invoiceStartsFrom: this.invoice.invoice_starts_from,
                autoGenerateInvoice: this.invoice.auto_generate_invoice,
                autoEmailReceive: this.invoice.auto_email_receive,
