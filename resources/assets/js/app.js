...
Vue.component('sales-list-component', require('./components/salesOrReceives/salesListComponent.vue'));
Vue.component('shipment-list-component', require('./components/salesOrReceives/shipmentListComponent.vue'));
...
Vue.component('sale-date-edit', require('./components/salesOrReceives/SalesDateEdit.vue'));
Vue.component('cart-component', require('./components/salesOrReceives/cart/cartComponent.vue'));
Vue.component('tax-edit-modal', require('./components/salesOrReceives/TaxEditModal.vue'));
Vue.component('table-selection-modal', require('./components/salesOrReceives/TableSelectionModal.vue'));
Vue.component('register-info-modal', require('./components/salesOrReceives/registerinfo.vue'));
Vue.component('datatable-invoice-modal-component', require('./components/salesOrReceives/DatatableInvoiceModalComponent'));

//Invoice
Vue.component('invoice', require('./components/salesOrReceives/invoice.vue'));
Vue.component('print-receipt-component', require('./components/salesOrReceives/PrintReceiptComponent.vue'));
