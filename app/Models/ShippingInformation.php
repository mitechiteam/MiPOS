...
class ShippingInformation extends BaseModel
{
    ...
    public static function getShipmentInfo($orderId)
    {
        return ShippingInformation::join('shipping_areas', 'shipping_information.shipping_area_id', 'shipping_areas.id')->select('shipping_areas.area', 'shipping_information.shipping_address')->where('shipping_information.order_id', $orderId)->first();
    }
