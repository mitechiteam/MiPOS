...
class Customer extends BaseModel
{
    ...
    public static function getCustomers($searchValue, $typeFilter, $columnName, $columnSortedBy, $limit, $offset, $requestType)
    {
        ...
        $query = Customer::leftJoin('customer_groups', 'customers.customer_group', '=', 'customer_groups.id');
    ...
    public static function getCustomerDetails(){
         return Customer::leftJoin('customer_groups', 'customers.customer_group', '=', 'customer_groups.id')
                        ->select(
                            'customers.*',
    ...
    {
        $query = Customer::join('customer_groups', 'customers.customer_group', '=', 'customer_groups.id')
