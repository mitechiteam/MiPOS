...
class EmailTemplateController extends Controller
{
    ...
    public function lowStockTamplateToPrint($branch, $lowStockProducts)
    {
    ...
    public function callCornJob()
    {
        ...
        if (isset($branches) && !empty($branches)) {
            ...
            //echo "Low stock notification complete \n";
        } else {
    ...
    public function sendPdf($branch, $mailText, $subject)
    {
        try {
            ...
            if (isset($lowStockProducts) && !empty($lowStockProducts)) {
                $template = $this->lowStockTamplateToPrint($branch, $lowStockProducts);
                ...
                //echo "Notification send for $branch->name \n";
            } else {
                //echo "Nothing to notify for $branch->name \n";
            }
        } catch (\Exception $e) {
